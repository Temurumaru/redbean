...
namespace ThreadBeanPHP\Util;

use ThreadBeanPHP\OODB as OODB;
 ...
 * 
 * @file    ThreadBeanPHP/Util/DispenseHelper.php
...
class DispenseHelper
{
	 ...
	 * TRUE the ThreadBeanPHP naming policy will be enforced.
	 ...
	 * type does not conform to the ThreadBeanPHP database column naming
	 * policy.
	 *
	 * The ThreadBeanPHP naming policy for beans states that valid
	 ...
	 *
	 * The ThreadBeanPHP naming policy ensures that, without any
