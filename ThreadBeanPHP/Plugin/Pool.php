...
namespace ThreadBeanPHP\Plugin;

use ThreadBeanPHP\ToolBox;
use ThreadBeanPHP\OODBBean;
use ThreadBeanPHP\OODB;
use ThreadBeanPHP\BeanHelper;
use ThreadBeanPHP\C;
 ...
 */
class NonStaticBeanHelper extends \ThreadBeanPHP\BeanHelper\SimpleFacadeBeanHelper {
 ...
 * </code>
 *
 * @file    ThreadBeanPHP/Plugin/Pool.php
 * @author  ThreadBeanPHP Community
 * @license BSD/GPLv2
 *
 * @copyright
