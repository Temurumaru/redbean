...
/**
 * SimpleModel
 * Base Model For All ThreadBeanPHP Models using FUSE.
 *
 * ThreadBeanPHP FUSE is a mechanism to connect beans to posthoc
 * models. Models are connected to beans by naming conventions.
 * Actions on beans will result in actions on models.
 *
 * @file       ThreadBeanPHP/SimpleModel.php
...
class SimpleModel
{
	 ...
	 * OODBBean. The method returns a ThreadBeanPHP Simple Model.
	 ...
	 * available in the model, this is just read-only. To use a model as a typical ThreadBean
