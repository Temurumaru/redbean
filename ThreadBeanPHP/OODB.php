...
use ThreadBeanPHP\Repository as Repository;
use ThreadBeanPHP\Repository\Fluid as FluidRepo;
use ThreadBeanPHP\Repository\Frozen as FrozenRepo;

/**
 * ThreadBean Object Oriented DataBase.
 *
 * The ThreadBean OODB Class is the main class of ThreadBeanPHP.
...
class OODB extends Observable
{
	 ...
	 * ThreadBeanPHP core objects. However if you would like to
	...
	/**
	 * Returns the current mode of operation of ThreadBean.
	 ...
	 * to be configured before you can use it with ThreadBean. This
