...
namespace ThreadBeanPHP\Driver;
...
use ThreadBeanPHP\RedException\SQL as SQL;
use ThreadBeanPHP\Logger\RDefault as RDefault;
use ThreadBeanPHP\PDOCompatible as PDOCompatible;
use ThreadBeanPHP\Cursor\PDOCursor as PDOCursor;

/**
 * PDO Driver
 * This Driver implements the ThreadBean Driver API.
 * for ThreadBeanPHP. This is the standard / default database driver
 * for ThreadBeanPHP.
 *
 * @file    ThreadBeanPHP/PDO.php
 * @author  Gabor de Mooij and the ThreadBeanPHP Community, Desfrenes
 * @license BSD/GPLv2
 *
 * @copyright
 * copyright (c) Desfrenes & Gabor de Mooij and the ThreadBeanPHP community
...
class RPDO implements Driver
{
	 ...
	 * </code>
	 *
	 * By default, ThreadBeanPHP uses this method under the hood to make sure
	 ...
	 * this method if you are an expert on ThreadBeanPHP, PDO and UTF8 connections and
	 * you know your database server VERY WELL.
	 *
	 * - connected     TRUE|FALSE (treat this instance as connected, default: TRUE)
	 * - setEncoding   TRUE|FALSE (let ThreadBeanPHP set encoding for you, default: TRUE)
	 * - setAttributes TRUE|FALSE (let ThreadBeanPHP set attributes for you, default: TRUE)*
	 ...
	 *
	 * *attributes:
	 * - ThreadBeanPHP will ask database driver to throw Exceptions on errors (recommended for compatibility)
         * - ThreadBeanPHP will ask database driver to use associative arrays when fetching (recommended for compatibility)
	 *
	 ...
	 * </code>
	 *
	 * The example above illustrates how to use the ThreadBeanPHP
	 ...
	 * PDO based database drivers for ThreadBeanPHP. Other drivers may not have
