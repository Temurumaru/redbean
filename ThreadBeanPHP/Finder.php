...
class Finder
{
	...
	*/
	 ...
	 * This method provides access to an underlying mechanism in the ThreadBeanPHP architecture
	 ...
	 * 50-250 records. Anything above that will gradually perform worse. ThreadBeanPHP was never
