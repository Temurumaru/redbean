 ...
 * ToolBox.
 *
 * The toolbox is an integral part of ThreadBeanPHP providing the basic
 * architectural building blocks to manager objects, helpers and additional tools
 * like plugins. A toolbox contains the three core components of ThreadBeanPHP:
 * the adapter, the query writer and the core functionality of ThreadBeanPHP in
 * OODB.
 *
 * @file      ThreadBeanPHP/ToolBox.php
