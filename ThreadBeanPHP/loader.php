...
define('REDBEANPHP_MAIN_DIR', 'phar://rb.phar/ThreadBeanPHP/');
...
if ( defined( 'REDBEANPHP_PLUGINS' ) ) {
    Phar::mount( 'ThreadBeanPHP/Plugin', REDBEANPHP_PLUGINS );
}

//make some classes available for backward compatibility
class ThreadBean_SimpleModel extends \ThreadBeanPHP\SimpleModel {};

if (!class_exists('R')) {
	class R extends \ThreadBeanPHP\Facade{};
}
