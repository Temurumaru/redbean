...
use ThreadBeanPHP\Cursor\NullCursor as NullCursor;
 ...
 * method.
 *
 * @file    ThreadBeanPHP/Repository.php
...
abstract class Repository
{
	 ...
	 * - It must have a type
	 * - The type must conform to the ThreadBeanPHP naming policy
	...
	{
		$OODBBEAN = defined( 'REDBEAN_OODBBEAN_CLASS' ) ? REDBEAN_OODBBEAN_CLASS : '\ThreadBeanPHP\OODBBean';
		$beans = array();
		for ( $i = 0; $i < $number; $i++ ) {
			$bean = new $OODBBEAN;
